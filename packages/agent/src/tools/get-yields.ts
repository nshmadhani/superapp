...
export function getYieldsTool() {
  return tool({
    description:
      "List USDC yield opportunities. Prefer Morpho vaults (executable via create_action_plan lend) — includes vault address + chainId. Also returns DeFiLlama pools for comparison (discovery-only unless Morpho).",
